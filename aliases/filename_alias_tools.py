...
def build_alias_functions(
    get_docs: Callable[[], Any], document_store
) -> Dict[str, Callable[..., Dict[str, Any]]]:

    def file_create_document(
    ...
    def file_set_page_setup(
        ...
        _layout.set_page_setup(
            did, margins=margins, orientation=orientation, paper=paper, columns=columns
        )
        return {}
    ...
    def file_render_page_base64(
        filename: str, page_index: int = 0, fmt: str = 'png', dpi: int = 150
    ):
        did = _resolve_doc_id_for_filename(get_docs, document_store, filename)
    ...
    return {
        'file_create_document': file_create_document,
        'file_get_document_info': file_get_document_info,
        'file_get_document_text': file_get_document_text,
        'file_get_document_outline': file_get_document_outline,
        'file_get_document_xml': file_get_document_xml,
        'file_convert_to_pdf': file_convert_to_pdf,
        'file_add_picture': file_add_picture,
        'file_add_header_text': file_add_header_text,
        'file_add_footer_text': file_add_footer_text,
        'file_add_page_numbering': file_add_page_numbering,
        'file_set_different_first_page_header_footer': file_set_different_first_page_header_footer,
        'file_set_page_setup': file_set_page_setup,
        'file_insert_section_break': file_insert_section_break,
        'file_insert_html_end': file_insert_html_end,
        'file_render_page_base64': file_render_page_base64,
        'file_export_base64_advanced': file_export_base64_advanced,
        'file_search_and_replace': file_search_and_replace,
        'file_delete_document': file_delete_document,
        'file_copy_document': file_copy_document,
        'file_list_available_documents': file_list_available_documents,
    }
...
def register_alias_tools(mcp, functions: Dict[str, Callable[..., Dict[str, Any]]]) -> List[str]:
    ...
    def file_add_picture(
        ...
        return functions['file_add_picture'](
            filename=filename,
    ...
    @mcp.tool()
    def file_set_different_first_page_header_footer(filename: str, enabled: bool = True):
        return functions['file_set_different_first_page_header_footer'](
    ...
    def file_set_page_setup(
        ...
        return functions['file_set_page_setup'](
            filename=filename,
            margins=margins,
    ...
    def file_render_page_base64(
        ...
        return functions['file_render_page_base64'](
            filename=filename, page_index=page_index, fmt=fmt, dpi=dpi
        )
    ...
    def file_search_and_replace(
        ...
        return functions['file_search_and_replace'](
            filename=filename,
            find_text=find_text,
    ...
    @mcp.tool()
    def file_copy_document(source_filename: str, destination_filename: Optional[str] = None):
        return functions['file_copy_document'](
