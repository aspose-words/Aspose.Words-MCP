...
def move_builder(
    doc: aw.Document, builder: aw.DocumentBuilder, where: str, paragraph_index: Optional[int]
) -> None:
    if where == 'start':
...
def find_paragraph_indices_by_anchor(
    doc: aw.Document, anchor_text: str, match_case: bool = False, whole_word: bool = False
) -> List[int]:
    if not anchor_text:
        return []
...
def resolve_heading_style_identifier(level: int):
    _MAP = {
        1: aw.StyleIdentifier.HEADING1,
        2: aw.StyleIdentifier.HEADING2,
        3: aw.StyleIdentifier.HEADING3,
        4: aw.StyleIdentifier.HEADING4,
        5: aw.StyleIdentifier.HEADING5,
        6: aw.StyleIdentifier.HEADING6,
        7: aw.StyleIdentifier.HEADING7,
        8: aw.StyleIdentifier.HEADING8,
        9: aw.StyleIdentifier.HEADING9,
    }
    return _MAP[level]
...
def resolve_outline_level(level: int):
    _MAP = {
        1: aw.OutlineLevel.LEVEL1,
        2: aw.OutlineLevel.LEVEL2,
        3: aw.OutlineLevel.LEVEL3,
        4: aw.OutlineLevel.LEVEL4,
        5: aw.OutlineLevel.LEVEL5,
        6: aw.OutlineLevel.LEVEL6,
        7: aw.OutlineLevel.LEVEL7,
        8: aw.OutlineLevel.LEVEL8,
        9: aw.OutlineLevel.LEVEL9,
    }
    return _MAP[level]
